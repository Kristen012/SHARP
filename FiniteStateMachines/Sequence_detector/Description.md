...
* **Description**
    ...
    This design detects the bit sequence 1001 in a continuous input stream. It outputs a match signal when the pattern is identified and supports persistent monitoring for overlapping or repeating sequences.
