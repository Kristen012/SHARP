...
#ifndef NATIVE_SYSTEMC
		output_t inVal_Y1_temp = o_Y1.get();
		output_t inVal_Y3_temp = o_Y3.get();
#else
		output_t inVal_Y1_temp = o_Y1.read();
		output_t inVal_Y3_temp = o_Y3.read();
#endif
		int inVal_Y1 = inVal_Y1_temp;
		int inVal_Y3 = inVal_Y3_temp;
